...
os.environ['STANFORD_PARSER'] = r'/users/ashu/stanford nlp/stanford-parser-full-2015-01-30'
os.environ['STANFORD_MODELS'] = r'/users/ashu/stanford nlp/stanford-parser-full-2015-01-30'
...
if __name__ == '__main__':
    try:
        ...
        print ("Enter in your sentence, please enter any sentece which you want the triples for...")
        sentence = 'A rare black squirrel has become a regular visitor to a suburban garden'
